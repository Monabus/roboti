...
/**************************************************************************
函数功能：刷子升降初始化 以及喷雾器的初始化 以及光电的初始化
入口参数：无 
返回  值：无
**************************************************************************/
void Equipment_init(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin   =   GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_2;// 扫地刷对应IO口		//EN DIR (使能、方向)		脉冲在定时器里面输出		//喷雾器
